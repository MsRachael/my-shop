...
import ProfileMenu from "./custom-ui/ProfileMenu";
      ...
      border-gray-500/50 transition-all duration-300 ease-in-out translate-x-6"
        ...
        <div className="flex items-center justify-start gap-6 px-4">
          <Link href="/cart" className="flex items-center justify-center gap-2">
            <Image src="/icons/cart.svg" alt="Menu" width={40} height={40}/>
          </Link>
          {isSignIn || authCheck ? null : (
            <button
              className="hidden md:block text-lg border-2 border-black/40 px-4 py-2 rounded-md
