...
export default function Profile({}: Props) {
  return (
    <div className="flex flex-col items-center justify-center gap-8 md:py-8">
      <div className="w-96 lg:w-[800px] flex flex-col md:flex-row items-center 
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex items-center justify-center gap-4">
              <Image
                ...
                width={150}
                height={150}
                className="h-32 w-32 object-contain shadow-sm p-2 rounded-full bg-slate-200"
              />
            </div>
            <div className="w-56 flex flex-col gap-2 text-md items-start justify-center">
              <h2 className="flex items-center">
                <Image src="/icons/man.svg" alt="User Icon" width={25} height={25} className="h-6 w-6" />
                <span className="ml-6">Male</span>
              </h2>
              <h2 className="flex items-center">
                <Image src="/icons/phone.svg" alt="User Icon" width={20} height={20} className="h-6 w-6" />
                <span className="ml-6">+91{" "}97454 55446</span>
              </h2>
              <h2 className="flex items-center font-medium">
                <Image src="/icons/email.svg" alt="User Icon" width={20} height={20} className="h-6 w-6" />
                <span className="ml-6">xyz@test.com</span>
              </h2>
              <h2 className="flex items-center">
                <Image src="/icons/address.svg" alt="User Icon" width={15} height={15} className="h-6 w-6" />
